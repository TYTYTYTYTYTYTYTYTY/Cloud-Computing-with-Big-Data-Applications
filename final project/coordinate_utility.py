...
class coordinate_utility():
    ...
    def add_points(point1, point2):
        ...
        if len(point1) == len(point2) and len(point1) ==2:
            point1 = coordinate_utility.Sphe2cart(point1)
            point2 = coordinate_utility.Sphe2cart(point2)


        return(coordinate_utility.Cart2Sphe((point1[0]+ point2[0],point1[1]+ point2[1],point1[2]+ point2[2])))
    ...
    def get_Eculidian_Distance(point1, point2):
        ...
        Cart1 = coordinate_utility.Sphe2cart(point1)
        Cart2 = coordinate_utility.Sphe2cart(point2)
        magnitude = 0
    ...
    def get_Distance(point1, point2, method):
        if method == "Eucl":
            return coordinate_utility.get_Eculidian_Distance(point1, point2)
        if method == "Circle":
            return coordinate_utility.get_GreatCircle_Distance(point1, point2)
        else:
            return 0
    ...
    def get_Cloest_Point(point, center_list, method):
        ...
        for center in center_list:
            dist.append(coordinate_utility.get_Distance(center, point, method))
